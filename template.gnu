...
set style line 4 linetype 4 linewidth 1 linecolor 2 pointtype 4 pointsize 1
...
plot 'summary-sort_xinni_201504091654_120G-128Mblocksize-60Reduce.csv'  using 2:6  with lines ls 1 title 'r16s09', \
